...
1. Go to the terminal and type:-
	...
	scp foodtrade@ftstaging.cloudapp.net:~/backups/2014-10-27.zip .
	scp katmandu@foodtradelite.cloudapp.net:var/backup/2014-10-27.zip .
 /var/backup/
...
2. Then go to project folder and inside that go to deploy_tools in terminal
3. type "fab live deploy" for deploying in live server
4. type" fab staging deploy" for deploying in staging server that might prompt you password of user Kau: "We are life in Kau" if live.
