...
class CouponForm(forms.Form):
    ...
    redeem_by = forms.DateField(label=u'redeem by', input_formats=['%Y-%m-%d', '%Y-%d-%m',], required=False, widget=forms.DateInput(format = '%Y-%m-%d', attrs={'placeholder': 'YYYY-MM-DD','class' : 'form-control'})) #forms.DateField(required=True, initial=datetime.date.today,) # widget=forms.TextInput(attrs={'placeholder': 'YYYY-MM-DD','class' : 'form-control'}))
    def __init__(self, *args, **kwargs):
