...
function get_box_update(update)
{
	...
	content +='<i class="fa fa-info-circle fa-lg fa-fw"></i> View profile</a></li>   ';
	content +='<li><a href="#" onclick="click_activity(\'follow\',\'xxxx\')"><i class="fa fa-star-o fa-fw"></i>  Follow on Twitter</a></li>';
	content +='<li><a href="#" class="deletetweet" data-tweet-id="xxxxx"><i class="fa fa-trash-o fa-fw flag"></i> Delete</a></li>';
	content +='<li><a href="#" onclick="click_activity(\'spam\',\'xxxx \')" class=" "><i class="fa fa-flag-o flag fa-fw"></i> Report</a></li>';
	content +='</ul>  ';
	content +='</div>  ';
