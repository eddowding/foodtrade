...
urlpatterns = patterns('menu.views',
    ...
    url(r'^stripe/coupon/value/$', 'stripe_coupon_value', name='menu_stripe_coupon_value'),
    ...
    url(r'^create/establishment/$', 'create_establishment', name='menu_create_establishment'),
