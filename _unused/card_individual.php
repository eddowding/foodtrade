    ...
    <div class="card card-individual">
      <div class="content">
        ...
        <div class="text">
          <h5><a href="#THEIRPROFILEPAGE">Hrair Mekhsian</a> <span class="label label-info pull-right">27</span></a></h5> 
          <p class="small">
          This is the one line description from their twitter profile.
        </div>
      </div>
